...
/** Which agents are assigned to which brain folders ('*' = everything). */
export const AGENT_BRAIN_SCOPES: Record<string, string[]> = {
  // NikOS roster — folders map to the diagnostic-map corpus + ops brain.
  conductor: ['*'],
  'data-agent': ['*'],
  'map-builder': ['canonical-maps'],
  'guided-qa': ['canonical-maps'],
  'fleet-coverage': ['canonical-maps'],
  'fieldops-agent': ['projects'],
  'release-gate': ['projects'],
  'ops-data': ['projects'],
  'dev-agent': ['projects'],
  'code-worker': ['projects'],
  'test-worker': ['projects'],
  'research-agent': ['*'],
  'bounty-radar': ['projects'],
  'surf-research': ['*'],
  'models-agent': ['models'],
  'eval-runner': ['models'],
  'training-run': ['models'],
